(function () {
  ...
  new MutationObserver((e) => {
    for (const o of e) if (o.type === 'childList') for (const a of o.addedNodes) a.tagName === 'LINK' && a.rel === 'modulepreload' && r(a);
...
const s = (i, t, n) => {
  ...
  r != null &&
    r.addEventListener('click', () => {
      const o = n[Math.floor(Math.random(new Date()) * n.length)];
      e.innerText = o;
    });
};
s('js-slotButton0', 'js-resultSongName0', T);
s('js-slotButton1', 'js-resultSongName1', l);
s('js-slotButton2', 'js-resultSongName2', A);
s('js-slotButton3', 'js-resultSongName3', S);
s('js-slotButton4', 'js-resultSongName4', u);
